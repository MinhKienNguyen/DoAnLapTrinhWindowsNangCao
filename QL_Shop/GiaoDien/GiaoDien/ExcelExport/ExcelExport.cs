...
namespace GiaoDien.Models
{
    public class ExcelExport
    {
        ...
        public bool ExportKhoa(List<HangHoaDTO> dataSource, ref string fileName, bool isPrintPreview)
        {
            // Check if data is null
          ...
          //  string tongSo = dataSource.Sum(t => t.SoLuong).Value.ToString();
            ...
            return OutSimpleReport(dataSource, replacer, T_BieuMau, isPrintPreview, ref fileName);
        }
